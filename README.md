...
### 🔔 תזכורות שבועיות
- הגדר יום ושעה קבועים לתזכורת הזמנה — toast מופיע פתיחת האפליקציה
...
- הגדר `APP_PASSWORD` ב-Render לדרוש סיסמה בכניסה למערכת
...
| `PORT` | פורט השרת | `8000` |
| `APP_PASSWORD` | סיסמת כניסה למערכת (אופציונלי) | ללא אימות |
